...
use IMITS::Util::CrisprDamageVEP;
use IMITS::Util::SCFVariationSeq;
use Getopt::Long;
...
my $qc = IMITS::Util::CrisprDamageVEP->new( %params );
...
sub variant_scf_to_fasta {
    ...
    my $scf_converter = IMITS::Util::SCFVariationSeq->new( %variant_params );
