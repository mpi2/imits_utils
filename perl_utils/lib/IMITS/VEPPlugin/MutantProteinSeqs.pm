package IMITS::VEPPlugin::MutantProteinSeqs;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $IMITS::VEPPlugin::MutantProteinSeqs::VERSION = '0.044';
}
## use critic
...
IMITS::VEPPlugin::MutantProteinSeqs

=head1 SYNOPSIS

perl variant_effect_predictor.pl -i variations.vcf --plugin IMITS::VEPPlugin::MutantProteinSeqs
