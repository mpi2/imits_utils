package IMITS::Util::CrisprAlleleDamage;
## no critic(RequireUseStrict,RequireUseWarnings)
{
    $IMITS::Util::CrisprAlleleDamage::VERSION = '0.030';
}
## use critic
...
use Moose;
use IMITS::Util::CigarParser;
use DesignCreate::Util::Exonerate;
use IMITS::Util::Alignment qw( alignment_match_on_target );
use Bio::SeqIO;
use Data::Dumper;
...
has cigar_parser => (
    is         => 'ro',
    isa        => 'IMITS::Util::CigarParser',
    lazy_build => 1,
);

sub _build_cigar_parser {
    my $self = shift;
    return IMITS::Util::CigarParser->new(
